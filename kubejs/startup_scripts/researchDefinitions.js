...
// Global variable for storing researches aka recipe stages
// Should be accessible to server and clients
...
global.researchStages = {
    ...
    "create_electric": {
        ...
        "ingredients": ["createaddition:rolling_mill", "createaddition:portable_energy_interface", "#kubejs:connectors"]
    },
    "create_powering": {
        "name": "Electrical Generation",
        "ingredients": ["createaddition:electric_motor", "createaddition:alternator", "createaddition:capacitor"]
    },
