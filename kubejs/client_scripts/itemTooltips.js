ItemEvents.tooltip(e => {
    ...
    e.add("splendid_slimes:slime_incubator", [
        "§8[§7 Incubates a slime heart into a new slime §8]",
        "§8[§7 Slime spawns infront of the incubator §8]"
    ])
    ...
    // Create additions
    e.add("createaddition:tesla_coil", ['§8[§7 Can charge items on a depot with energy §8]'])
    // Botania
    ...
    e.add("alexscaves:candy_cane_hook", ["§8[§7 Pulls you to the hooks location §8]", "§8[§7 Enchantable for much more power §8]"])
    e.add("alexscaves:rainbounce_boots", ["§8[§7 Prevents fall damage and lets you bounce §8]", "§8[§7 Might want to muffle the sound in your inventory... §8]"])
})
